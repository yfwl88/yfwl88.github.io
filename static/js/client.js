...
var frontpage = [
	...
	"",
	"",
	"Welcome to tmpchat.com, a minimal, distraction-free chat application.",
	"Channels are created, joined and shared with the url, create your own channel by changing the text after the question mark.",
	"If you wanted your channel name to be 'your-channel': https://0203.fun/?tmpchat",
	...
	"?games ?banana",
	"And here's a random one generated just for you: ?" + Math.random().toString(10).substr(2, 7),
	"",
	"Formatting:",
	...
	"No message history is retained on the 0203.fun server."
].join("\n");
